		...
		// Create the ORB (or connect to it in our case)
				...
				//	Dialogue dialogue = (Dialogue)
					...
					// dump the message to console
				 	 Dialogue dialogue=  connexion.connect("Moussa");
				 	 
				 	 dialogue.sendMessage("Achraf", "Le message1");
                      Message[] msg = dialogue.getMessages("Moussa");
				 	  Client[] clients = dialogue.getClients();
				 	 	
				 	 
				 	System.out.println("NOmbre de client : " + clients.length);
				 	System.out.println("NOmbre de Message de mousa : " + msg.length);
